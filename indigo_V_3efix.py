...
from indigoclass_V_3efix import * #import the FUNCTIONS from the CLASSES
...
#passing data variables for holding
pass_data.hold=hold
pass_data.jfix=jfix
pass_data.jvalue=jvalue
pass_data.btextbxydata=btextbxydata
